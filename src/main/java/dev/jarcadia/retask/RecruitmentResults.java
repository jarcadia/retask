...
class RecruitmentResults {
    ...
    private final Map<HandlerSource, List<HandlerMethod>> handlersByType;
	...
	public RecruitmentResults(List<HandlerMethod> handlers,
			...
			Map<HandlerSource, List<HandlerMethod>> handlersByType,
	...
	protected List<HandlerMethod> getHandlers(HandlerSource type) {
